...
<asp:Content ID="Content2" ContentPlaceHolderID="contentplaceholder1" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GridView1"  runat="server"  Onrowupdating="Student_GridView_RowUpdating" onrowupdated="Student_GridView_RowUpdated" onrowcancelingedit="StudentGridView_RowCancelingEdit"  onrowediting="StudentGridView_RowEditing"  AutoGenerateColumns="False" autogenerateeditbutton="true"  Height="156px" HorizontalAlign="Center" Width="910px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" >
            <Columns>
